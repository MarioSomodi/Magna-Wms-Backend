...
public sealed class StartPickTaskCommandHandler
    : IRequestHandler<StartPickTaskCommand, Result<PickTaskDto>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return Result<PickTaskDto>.Failure(
                new Error(ErrorCode.Forbidden, "You cannot start this pick task."));
        }
